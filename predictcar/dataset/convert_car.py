...
def _get_filenames_and_classes(dataset_dir):
    ...
    """
    class_names = ['Audi', 'Bmw', 'Buick','Chevrolet','Ford','Honda','Hyundai','Nissan','Toyota','Vm']
...
def _get_dataset_filename(dataset_dir,split_name,shard_id):
    ...
    :return:
    """
    output_filename = 'Car_%s_%05d-of-%05d.tfrecord'%(split_name,shard_id,_NUM_SHARDS)
        ...
        with tf.Session() as sess:
            ...
            with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
                ...
                for i in list(range(start_ndx,end_ndx)):
                    ...
                    imagename,class_name = filenames[i].split(os.sep)[-1],filenames[i].split(os.sep)[-2]
